...
- [ADR-024](https://github.com/sabinabernardes/RickAndMorty/blob/master/.claude/adrs/ADR-024-feature-auth-simulada.md) — decisões arquiteturais
- [:core:security](Core-Security) — armazenamento seguro de tokens
- [Screenshot Testing com Roborazzi](Screenshot-Testing-Roborazzi) — como os goldens da LoginScreen funcionam
- 
