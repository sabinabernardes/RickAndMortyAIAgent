...
- **Modularization**: Feature-based modularization (`:feature:home`, `:feature:character_details`).
- **Core Modules**: Shared logic stays in `:core` modules (`:core:network`, `:core:designsystem`, `:core:navigation`).
